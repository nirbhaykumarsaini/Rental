...
orderSchema.pre('save', async function(next) {
  if (!this.orderNumber) {
    ...
    this.orderNumber = `${dateStr}${random}`;
  }
...
orderSchema.pre('save', function() {
  ...
  this.totalAmount = this.subtotal + this.shippingCharge + (this.tax || 0) - (this.discount || 0);
...
orderSchema.statics.findByUserId = function(userId: string | mongoose.Types.ObjectId) {
...
orderSchema.statics.getOrderStats = async function(userId?: string | mongoose.Types.ObjectId) {
